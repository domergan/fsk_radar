...
Python implementation of a BFSK radar using the BGT24ATR22-YPA Doppler radar evaluation board. Builds on the Time-Frequency-Range diagram method described by Rogers (2007).
